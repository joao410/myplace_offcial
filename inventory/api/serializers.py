...
from ..models import Places,Inputs,Manufacturer,Manufacturer_address,Stock_loc,Contacts,Log_association,Log_defect,Log_entrance,Log_Movimantation
...
class Logdefectserializer(serializers.ModelSerializer):
    code = Inputserializer(many=False)
    class Meta:
        model= Log_defect
        fields = '__all__'
class Logemovimentationserializer(serializers.ModelSerializer):
    code = Inputserializer(many=False)
    class Meta:
        model= Log_Movimantation
        fields = '__all__'
